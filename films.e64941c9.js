 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Li="".concat(p.SDK_VERSION,"_lite"),Mt=Li,(0,p._registerComponent)(new(0,m.Component)("firestore/lite",(function(e,t){var n=t.instanceIdentifier,r=t.options,i=e.getProvider("app").getImmediate(),a=new ai(new ln(e.getProvider("auth-internal")),new pn(e.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new sn(Qt,'"projectId" not provided in firebase.initializeApp.');return new yn(e.options.projectId,t)}(i,n),i);return r&&a._setSettings(r),a}),"PUBLIC").setMultipleInstances(!0)),(0,p.registerVersion)("firestore-lite","3.5.0",""),(0,p.registerVersion)("firestore-lite","3.5.0","esm2017");var ji,qi,Ui,Bi,zi=(0,s.initializeApp)({apiKey:"AIzaSyBMQEt78CaPaq3dSOfApmBG4vPslBGp6pQ",authDomain:"filmoteka-5bf07.firebaseapp.com",projectId:"filmoteka-5bf07",storageBucket:"filmoteka-5bf07.appspot.com",messagingSenderId:"626342412224",appId:"1:626342412224:web:b02b966cc92ff4eefbd225",measurementId:"G-X5BM5EZZVP"}),Ki=(function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:(0,p.getApp)();e=(0,y.getModularInstance)(e);var t=(0,p._getProvider)(e,Re);t.isInitialized()?t.getImmediate():St(e)}(zi),Ui="object"==typeof(ji=zi)?ji:(0,p.getApp)(),Bi="string"==typeof ji?ji:qi||"(default)",(0,p._getProvider)(Ui,"firestore/lite").getImmediate({identifier:Bi})),Gi=ci(Ki,"watched");Oi(ci(Ki,"queue")).then((function(t){var n=[];t.docs.forEach((function(t){n.push(e(o)({},t.data(),{id:t.id}))})),console.log(n)})).catch((function(e){console.log(e.message)})),Oi(Gi).then((function(t){var n=[];t.docs.forEach((function(t){n.push(e(o)({},t.data(),{id:t.id}))})),console.log(n)})).catch((function(e){console.log(e.message)}));var Yi=document.querySelector(".modal-film-wrap");Yi.addEventListener("submit",(function(e){e.preventDefault(),Mi(Gi,{id:Yi.title.value,adult:Yi.author.value}).then((function(){Yi.reset()}))}))}();
//# sourceMappingURL=films.e64941c9.js.map
