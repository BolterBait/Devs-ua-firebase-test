 ...
 * limitations under the License.
 */
class kn{get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Pn(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new kn(this.firestore,t,this._key)}constructor(t,e,n){this.converter=e,this._key=n,this.type="document",this.firestore=t}}class An{withConverter(t){return new An(this.firestore,t,this._query)}constructor(t,e,n){this.converter=e,this._query=n,this.type="query",this.firestore=t}}class Pn extends An{get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new kn(this.firestore,null,new Ut(t))}withConverter(t){return new Pn(this.firestore,t,this._path)}constructor(t,e,n){super(t,e,new Oe(n)),this._path=n,this.type="collection"}}function Cn(t,e,...n){if(t=(0,o.getModularInstance)(t),Bt("collection","path",e),t instanceof En){const i=jt.fromString(e,...n);return Kt(i),new Pn(t,null,i)}{if(!(t instanceof kn||t instanceof Pn))throw new Pt("invalid-argument","Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const i=t._path.child(jt.fromString(e,...n));return Kt(i),new Pn(t.firestore,null,i)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ri;ri=`${s.SDK_VERSION}_lite`,vt=ri,(0,s._registerComponent)(new(0,l.Component)("firestore/lite",((t,{instanceIdentifier:e,options:n})=>{const i=t.getProvider("app").getImmediate(),r=new En(new Dt(t.getProvider("auth-internal")),new Rt(t.getProvider("app-check-internal")),function(t,e){if(!Object.prototype.hasOwnProperty.apply(t.options,["projectId"]))throw new Pt("invalid-argument",'"projectId" not provided in firebase.initializeApp.');return new Mt(t.options.projectId,e)}(i,e),i);return n&&r._setSettings(n),r}),"PUBLIC").setMultipleInstances(!0)),(0,s.registerVersion)("firestore-lite","3.5.0",""),(0,s.registerVersion)("firestore-lite","3.5.0","esm2017");const si=(0,r.initializeApp)({apiKey:"AIzaSyBMQEt78CaPaq3dSOfApmBG4vPslBGp6pQ",authDomain:"filmoteka-5bf07.firebaseapp.com",projectId:"filmoteka-5bf07",storageBucket:"filmoteka-5bf07.appspot.com",messagingSenderId:"626342412224",appId:"1:626342412224:web:b02b966cc92ff4eefbd225",measurementId:"G-X5BM5EZZVP"}),ai=(function(t=(0,s.getApp)()){t=(0,o.getModularInstance)(t);const e=(0,s._getProvider)(t,"analytics");e.isInitialized()?e.getImmediate():function(t,e={}){const n=(0,s._getProvider)(t,"analytics");if(n.isInitialized()){const t=n.getImmediate();if((0,o.deepEqual)(e,n.getOptions()))return t;throw W.create("already-initialized")}n.initialize({options:e})}(t)}(si),function(t,e){const n="object"==typeof t?t:(0,s.getApp)(),i="string"==typeof t?t:e||"(default)";return(0,s._getProvider)(n,"firestore/lite").getImmediate({identifier:i})}(si)),oi=Cn(ai,"watched");ni(Cn(ai,"queue")).then((t=>{let e=[];t.docs.forEach((t=>{e.push({...t.data(),id:t.id})})),console.log(e)})).catch((t=>{console.log(t.message)})),ni(oi).then((t=>{let e=[];t.docs.forEach((t=>{e.push({...t.data(),id:t.id})})),console.log(e)})).catch((t=>{console.log(t.message)}));const li=document.querySelector(".modal-film-wrap");li.addEventListener("submit",(t=>{t.preventDefault(),ii(oi,{id:li.title.value,adult:li.author.value}).then((()=>{li.reset()}))}));
//# sourceMappingURL=films.5ce92e17.js.map
