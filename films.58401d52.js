 ...
 * limitations under the License.
 */
function oe(e,t,n){if(!n)throw new G(N,"Function ".concat(e,"() cannot be called with an empty ").concat(t,"."))}function se(e){if(!ae.isDocumentKey(e))throw new G(N,"Invalid document reference. Document references must have an even number of segments, but ".concat(e," has ").concat(e.length,"."))}function ue(e){if(ae.isDocumentKey(e))throw new G(N,"Invalid collection reference. Collection references must have an odd number of segments, but ".concat(e," has ").concat(e.length,"."))}function ce(e){if(void 0===e)return"undefined";if(null===e)return"null";if("string"==typeof e)return e.length>20&&(e="".concat(e.substring(0,20),"...")),JSON.stringify(e);if("number"==typeof e||"boolean"==typeof e)return""+e;if("object"==typeof e){if(e instanceof Array)return"an array";var t=(n=e).constructor?n.constructor.name:null;return t?"a custom ".concat(t," object"):"an object"}var n;return"function"==typeof e?"a function":A()}function le(e,t){if("_delegate"in e&&(e=e._delegate),!(e instanceof t)){if(t.name===e.constructor.name)throw new G(N,"Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");var n=ce(e);throw new G(N,"Expected type '".concat(t.name,"', but it was: ").concat(n))}return e}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ye(e){if(void 0===e)return _("RPC_ERROR","HTTP error has no status"),F;switch(e){case 200:return"ok";case 400:return j;case 401:return M;case 403:return O;case 404:return R;case 409:return q;case 416:return U;case 429:return L;case 499:return C;case 500:return F;case 501:return B;case 503:return K;case 504:return V;default:return e>=200&&e<300?"ok":e>=400&&e<500?j:e>=500&&e<600?z:F}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var Gt=function(){"use strict";function e(n,r,i){t(o)(this,e),this.converter=r,this._key=i,this.type="document",this.firestore=n}return t(u)(e,[{key:"_path",get:function(){return this._key.path}},{key:"id",get:function(){return this._key.path.lastSegment()}},{key:"path",get:function(){return this._key.path.canonicalString()}},{key:"parent",get:function(){return new Ht(this.firestore,this.converter,this._key.path.popLast())}},{key:"withConverter",value:function(t){return new e(this.firestore,t,this._key)}}]),e}(),Yt=function(){"use strict";function e(n,r,i){t(o)(this,e),this.converter=r,this._query=i,this.type="query",this.firestore=n}return t(u)(e,[{key:"withConverter",value:function(t){return new e(this.firestore,t,this._query)}}]),e}(),Ht=function(e){"use strict";t(f)(r,e);var n=t(v)(r);function r(e,i,a){var s;return t(o)(this,r),(s=n.call(this,e,i,new Ze(a)))._path=a,s.type="collection",t(h)(s)}return t(u)(r,[{key:"id",get:function(){return this._query.path.lastSegment()}},{key:"path",get:function(){return this._query.path.canonicalString()}},{key:"parent",get:function(){var e=this._path.popLast();return e.isEmpty()?null:new Gt(this.firestore,null,new ae(e))}},{key:"withConverter",value:function(e){return new r(this.firestore,e,this._path)}}]),r}(Yt);function Qt(e,n){for(var r=arguments.length,i=new Array(r>2?r-2:0),a=2;a<r;a++)i[a-2]=arguments[a];if(e=(0,w.getModularInstance)(e),oe("collection","path",n),e instanceof zt){var o,s=(o=ne).fromString.apply(o,[n].concat(t(p)(i)));return ue(s),new Ht(e,null,s)}var u;if(!(e instanceof Gt||e instanceof Ht))throw new G(N,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");var c=e._path.child((u=ne).fromString.apply(u,[n].concat(t(p)(i))));return ue(c),new Ht(e.firestore,null,c)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var K=new Map;function G(e,t){var n=z(e);Y(n,t),function(e,t){var n=Q();n&&n.postMessage({key:e,fid:t});W()}(n,t)}function Y(e,t){var n=K.get(e);if(n){var r=!0,i=!1,a=void 0;try{for(var o,s=n[Symbol.iterator]();!(r=(o=s.next()).done);r=!0){(0,o.value)(t)}}catch(e){i=!0,a=e}finally{try{r||null==s.return||s.return()}finally{if(i)throw a}}}}var H=null;function Q(){return!H&&"BroadcastChannel"in self&&((H=new BroadcastChannel("[Firebase] FID Change")).onmessage=function(e){Y(e.data.key,e.data.fid)}),H}function W(){0===K.size&&H&&(H.close(),H=null)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Fe="installations",Ne=function(e){var t=e.getProvider("app").getImmediate(),n=
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){if(!e||!e.options)throw Ce("App Configuration");if(!e.name)throw Ce("App Name");var t=!0,n=!1,r=void 0;try{for(var i,a=["projectId","apiKey","appId"][Symbol.iterator]();!(t=(i=a.next()).done);t=!0){var o=i.value;if(!e.options[o])throw Ce(o)}}catch(e){n=!0,r=e}finally{try{t||null==a.return||a.return()}finally{if(n)throw r}}return{appName:e.name,projectId:e.options.projectId,apiKey:e.options.apiKey,appId:e.options.appId}}(t);return{app:t,appConfig:n,heartbeatServiceProvider:(0,v._getProvider)(t,"heartbeat"),_delete:function(){return Promise.resolve()}}},Ve=function(e){var t=e.getProvider("app").getImmediate(),n=(0,v._getProvider)(t,Fe).getImmediate(),r={getId:function(){return function(e){return Ee.apply(this,arguments)}(n)},getToken:function(e){return function(e){return Ae.apply(this,arguments)}(n,e)}};return r};(0,v._registerComponent)(new(0,g.Component)(Fe,Ne,"PUBLIC")),(0,v._registerComponent)(new(0,g.Component)("installations-internal",Ve,"PRIVATE")),(0,v.registerVersion)(b,x),(0,v.registerVersion)(b,x,"esm2017");
/**
 * @license
 * Copyright 2019 Google LLC
 *
